            ...
            <div className="mb-4 text-gray-300">
              ...
              <div className="flex gap-3">
                <RectangleVerticalIcon
                  ...
                  className={`p-2.5 size-12 bg-white/6 rounded-2xl transition-all ring-2 ring-transparent cursor-pointer ${aspectRatio === "9:16" ? "ring-violet-500/50 bg-white/10" : ""}`}
                />
                <RectangleHorizontalIcon
                  onClick={() => setAspectRatio("16:9")}
                  className={`p-2.5 size-12 bg-white/6 rounded-2xl transition-all ring-2 ring-transparent cursor-pointer ${aspectRatio === "16:9" ? "ring-violet-500/50 bg-white/10" : ""}`}
                />
              </div>
            </div>
